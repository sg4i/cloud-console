...
func request_ConsoleService_GenerateRoleLoginURL_0(ctx context.Context, marshaler runtime.Marshaler, client ConsoleServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GenerateRoleLoginURLRequest
		metadata runtime.ServerMetadata
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.GenerateRoleLoginURL(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ConsoleService_GenerateRoleLoginURL_0(ctx context.Context, marshaler runtime.Marshaler, server ConsoleServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GenerateRoleLoginURLRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.GenerateRoleLoginURL(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterConsoleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConsoleServiceServer) error {
	mux.Handle(http.MethodPost, pattern_ConsoleService_GenerateRoleLoginURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ConsoleService_GenerateRoleLoginURL_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ConsoleService_GenerateRoleLoginURL_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterConsoleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConsoleServiceClient) error {
	mux.Handle(http.MethodPost, pattern_ConsoleService_GenerateRoleLoginURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ConsoleService_GenerateRoleLoginURL_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_ConsoleService_GenerateRoleLoginURL_0 = runtime.ForwardResponseMessage
)
